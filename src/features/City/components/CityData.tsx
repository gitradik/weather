  ...
  return (
    <Grid container>
        ...
        <Box display="flex">
          <Typography
            ...
            sx={{ fontWeight: 'bold', mr: '3px' }}>
              Feels like {Math.round(feelsLike)}°С. {description.charAt(0).toUpperCase() + description.slice(1)}
          </Typography>
        </Box>
      </Grid>
      <Grid item xs={12} display="flex" alignItems="center" pt={2}>
        ...
        />
        <Box>
          <Typography variant="subtitle2">{speed.toPrecision(2)}m/s NNE</Typography>
        ...
        <Box ml={4}>
          ...
          <Typography variant="subtitle2">Visibility: {(visibility / 1000).toFixed(1)}km</Typography>
        </Box>
      </Grid>
    </Grid>
  )
